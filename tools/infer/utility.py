...
def init_args():
    ...
    parser.add_argument("--rec_algorithm", type=str, default='SVTR_HGNet')
    ...
    #
    parser.add_argument(
        "--draw_img_save_dir", type=str, default="./inference_results(1)")
    parser.add_argument("--save_crop_res", type=str2bool, default=False)
    parser.add_argument("--crop_res_save_dir", type=str, default="./model")
