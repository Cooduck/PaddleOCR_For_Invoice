...
class DPModule(nn.Layer):
    ...
    Depth-wise and point-wise module.
     Args:
        ...
        out_channel (int): The model channels of this Module.
...
class DarknetBottleneck(nn.Layer):
    ...
    final model. Each ConvModule is composed of Conv, BN, and act.
    The first convLayer has filter size of 1x1 and the second one has the
    filter size of 3x3.
    Args:
        in_channels (int): The input channels of this Module.
        out_channels (int): The model channels of this Module.
...
class CSPLayer(nn.Layer):
    ...
    Args:
        ...
        out_channels (int): The model channels of the CSP layer.
...
class CSPPAN(nn.Layer):
    ...
    Args:
        ...
        out_channels (int): Number of model channels (used at each scale)
        kernel_size (int): The conv2d kernel size of this Module.
