...
VERSION = '2.7.0.3'
SUPPORT_REC_MODEL = ['CRNN', 'SVTR_LCNet', 'SVTR_HGNet']
...
class PaddleOCR(predict_system.TextSystem):
    def __init__(self, **kwargs):
        ...
        params.det_model_dir = './model/ppocr4_det'
        params.rec_model_dir = './model/ppocr4_rec'
        params.cls_model_dir = './model/ch_ppocr_mobile_v2.0_cls'
        ...
        params.rec_char_dict_path = './ppocr/utils/ppocr_keys_v1.txt'
